...
--
-- Servidor: localhost
-- Tiempo de generaciÃ³n: 09-06-2013 a las 23:33:55
...
(1, 'Antonio', 'Pardeza Gomez', '72154578F', 'Calle Pando nÂº 3 3ÂºF', 'anto@parde.com', '1234', 942851456, 1, '1A', 4),
(2, 'Juan', 'De Dios', '721458935', 'Calle Las Rosas nÂº4 4ÂºJ', 'jdios@mail.com', '1234', 942584758, 2, '1B', 1),
(3, 'Isabel', 'Fernandez Garcia', '72568545W', 'Calle Sierra nÂº3 9ÂºH', 'isa@mail.com', '1234', 618452365, 3, '2A', 2),
(4, 'Beatriz', 'Lopez Ingunza', '72651534O', 'Calle Piruleta nÂº2 8ÂºA', 'bea@gmail.com', '1234', 685324592, 4, '1A', 3),
(5, 'Sonia', 'Velez Estibez', '72451478U', 'Calle Carmona nÂº1 1ÂºA', 'soni@mail.com', '1234', 613256478, 1, '1A', 1),
(6, 'Testo', 'Probatore', '123456789', 'Calle Prueba nÂº0 0Âºa', 'test@mail.com', '1234', 666666666, 1, '1A', 4),
(7, 'Usuario', 'de Prueba', '99999999T', 'Calle Prueba nÂº1 1Âºa', 'pruebas@mail.com', '1234', 999999999, 3, '1A', 3);
...
(2, 'I.E.S ZapatÃ³n', 'Torrelavega', 'Cantabria'),
(3, 'I.E.S. Augusto Garci', 'Santander', 'Cantabria'),
(4, 'I.E.S. Barajas', 'Madrid', 'Madrid'),
(5, 'Colegio Nuestra SeÃ±o', 'Torrelavega', 'Cantabria'),
...
(1, 'MatemÃ¡ticas', 'Materia sobre nÃºmeros.'),
(2, 'Lenguaje', 'Materia sobre la lengua castellana.'),
(3, 'Fisica', 'Materia sobre la fÃ­sica de la tierra.'),
(4, 'Dibujo', 'Materia de creaciÃ³n artÃ­stica.'),
(5, 'EducaciÃ³n FÃ­sica', 'Materia deportiva.'),
(6, 'TutorÃ­a', 'Charlas con el tutor.');
...
(1, 'Juan Antonio', 'Pardeza Gutierrez', '72564815P', 'Calle Pando nÂº 3 3ÂºF', 'juanan@papi.com', '1234', 616856415, 1);
...
(1, 'Ramiro', 'Carballo Lopez', '72548312A', 'Calle Falsa nÂº123 1ÂºH', 'ramiro@profe.com', '1234', 914785623, 1, 1, 1, 1);
